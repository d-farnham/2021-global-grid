...
def preprocess_input(case_input_path_filename):
    ...
    keywords_real = ['numerics_scaling','fixed_cost','var_cost','charging_time',
                     ...
                     'co2_price', 'co2_constraint', 'mean_dispatch','fraction_land','length','line_loss',
                     'converter_pair_loss','line_cost_land','line_cost_sea','converter_pair_cost']
    ...
    tech_keywords['transmission'] = ['tech_name','tech_type','node_to','node_from','fixed_cost','var_cost','efficiency','capacity','fixed_co2','max_capacity',
                                     'fraction_land','length','line_loss','converter_pair_loss','line_cost_land','line_cost_sea','converter_pair_cost']
