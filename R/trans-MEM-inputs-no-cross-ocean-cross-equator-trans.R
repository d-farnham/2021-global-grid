...
# now let's remove the cross ocean and crooss equator trans lines
trans_case_inputs = trans_case_inputs %>% dplyr::filter(!(node_from == 'node_1' & node_to == 'node_18'),
                                                        !(node_from == 'node_2' & node_to == 'node_11'),
                                                        !(node_from == 'node_8' & node_to == 'node_15'),
                                                        !(node_from == 'node_9' & node_to == 'node_26'),
                                                        !(node_from == 'node_17' & node_to == 'node_25'),
                                                        !(node_from == 'node_6' & node_to == 'node_7'),
                                                        !(node_from == 'node_6' & node_to == 'node_9'),
                                                        !(node_from == 'node_15' & node_to == 'node_17'),
                                                        !(node_from == 'node_16' & node_to == 'node_17'),
                                                        !(node_from == 'node_24' & node_to == 'node_25'))
